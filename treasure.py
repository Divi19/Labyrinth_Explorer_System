...
class Treasure:
    ...
    @property
    def product_of_ratio_and_weight(self):
        return self.value_to_weight_ratio * self.weight if self.weight > 0 else 0

    def __lt__(self, other: Treasure) -> bool:
        """Less than operator for comparing value-to-weight ratios."""
        return self.value_to_weight_ratio < other.value_to_weight_ratio

    def __le__(self, other: Treasure) -> bool:
        """Less than or equal to operator for comparing value-to-weight ratios."""
        return self.value_to_weight_ratio <= other.value_to_weight_ratio

    def __gt__(self, other: Treasure) -> bool:
        """Greater than operator for comparing value-to-weight ratios."""
        return self.value_to_weight_ratio > other.value_to_weight_ratio

    def __ge__(self, other: Treasure) -> bool:
        """Greater than or equal to operator for comparing value-to-weight ratios."""
        return self.value_to_weight_ratio >= other.value_to_weight_ratio
